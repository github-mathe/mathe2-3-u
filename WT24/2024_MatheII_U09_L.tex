...
\newcommand{\BLATT}{9}
\newcommand{\TOPIC}{Taylor-Polynom, Extrempunkte, Äquipotentialfläche}
...
\input{../A/Analysis/directional_derivative_scalar_field_001.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}{}
...
\input{../A/Analysis/analys_Tayl_Ndim_002.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}{}
\newpage
