...
\input{../A/Lineare_Algebra/linalg_Posi_Defi_001.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}

% \input{../A/Lineare_Algebra/linalg_Abbi_Klau_01b.tex}
% \ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}

\input{../A/Lineare_Algebra/linalg_Abbi_Kmpl_001.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}

\input{../A/Lineare_Algebra/linalg_Detn_Gauss_001.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}

\input{../A/Lineare_Algebra/linalg_Detn_Lapl_001.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}
% 
\input{../A/Lineare_Algebra/linalg_Matr_Symm_003.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}

% \input{../A/Lineare_Algebra/linalg_Matr_Invt_003.tex}
% \ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}
...
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}
\input{../A/Analysis/analys_inverse.tex}
\ifthenelse{\boolean{mitLoes}}{\ruleBig \cleardoublepage}
