...
\item Das Polynom $p(\lambda)=\lambda^4+2\lambda^3+\lambda^2$ hat die Nullstellen\newline
...
y_p^{(4)}(x)=0$$ Eingesetzt in die DGL:
$$ 0 + 12a + 6ax+2b
   = 12x $$
...
\item Das Polynom $p(\lambda)=\lambda^2+4\lambda+5$ hat die Nullstellen
