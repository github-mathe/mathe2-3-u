...
{
Klassifizieren die folgende Differentialgleichung und bestimmen Sie die Lösung des Anfangswertproblems mit $y(0) = 0$ und $y'(0) = 6$:
 $$
 y''(x) - 2 y'(x) - 3y(x) = 0.
 $$
}
...
\Loesung{
Klassifizierung: lineare Dgl. 2. Ordnung, konstante Koeffizienten, homogen. \\
