...
$$
2A\sqrt{\rho -\omega} \operatorname{e}^{(-\rho+ \sqrt{\rho^2 - \omega^2})t} = \operatorname{e}^{(-\rho + \sqrt{\rho^2 - \omega^2})t}
$$
Damit ist $A= \frac{1}{2\sqrt{\rho -\omega}}$.
Die partikuläre Lösung ist
$$
y_p = \frac{1}{2\sqrt{\rho -\omega}}t \operatorname{e}^{(-\rho + z)t}.
$$
Damit ist die allgemeine Lösung 
\begin{align*}
y = A\operatorname{e}^{(-\rho + \sqrt{\rho^2 - \omega^2})t} + B\operatorname{e}^{(-\rho - \sqrt{\rho^2 - \omega^2})t} + \frac{1}{2\sqrt{\rho -\omega}}t \operatorname{e}^{(-\rho + z)t}.
\end{align*}
...
\[
y_h(t) = t^2 \operatorname{e}^{-\omega t}.
\]
...
$$
y = t^2 \operatorname{e}^{-\omega t} + \frac{1}{2}t^2 \operatorname{e}^{-\omega t}.
$$
