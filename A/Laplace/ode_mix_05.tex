...
\ErgebnisC{odemix05}{
\begin{abc}
\item $\mathcal{L}\left\{f(t)\right\} = \int_0^\infty \operatorname{e}^{-st} f(t) \d t$
...
\item Nein
\item /
\item $\int_{-\infty}^\infty \delta(t) \d t = 1, \, \int_{-\infty}^\infty \delta(t-a) \d t = 1, \, \int_{-\infty}^\infty \delta(t-t_0)\, f(t) \d t = f(t_0)$
\end{abc}
}
