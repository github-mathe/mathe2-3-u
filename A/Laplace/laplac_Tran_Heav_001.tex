...
\textbf{a)} \ Mit Hilfe der Integraldarstellung der Definition.

\textbf{b)} \ Mit Hilfe des Verschiebungssatzes und der Tabelle der Laplace--Transformierten.
}
...
$\left(\frac{2}{s^3}+\frac{4}{s^2}+\frac{4}{s}\right)\cdot\EH{-2\,s}$
}
