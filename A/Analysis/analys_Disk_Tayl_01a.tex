...
\item Bestimmen Sie eine Asymptote von $f$, also eine Gerade $g(x)=a+bx$ mit 
$$\underset{x\to\pm\infty}\lim(f(x)-g(x))=0.$$
...
\item Die Funktion $g(x)=0$ ist Asymptote der Funktion $f(x)$: 
\begin{align*}
\underset{x\to\pm \infty}\lim (f(x)-g(x))=&\underset{x\to\pm\infty}\lim (\EH{-x^2/2}(2x-3)-0)\\
...
\psplot[plotpoints=200, plotstyle=curve, linecolor=lightgray]
{0}{4}
