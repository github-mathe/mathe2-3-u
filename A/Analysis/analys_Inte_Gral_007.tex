...
$$u(x)=2\cos x, \qquad \mathrm{d} u = -2\sin x \, \mathrm{d} x. $$
Eingesetzt ergibt das
\begin{align*}
I=& \int\limits_0^{\pi} \sin x \EH{2\cos x}\, \mathrm{d}x \\
=& -\frac 12 \int\limits_{u(0)}^{u(\pi)}\EH{u}\, \mathrm{d} u=-\frac 12 \left[ \EH
...
\begin{align*}
\int\limits_B\sqrt{x^2+y^2}\, \mathrm{d} x \, \mathrm{d} y = & \int\limits_{\varphi=0}^{2\pi } \int\limits_{r=a}^br r \, \mathrm{d}
  r \, \mathrm{d}\varphi
= 2\pi \frac{b^3-a^3}3.
\end{align*}
...
\begin{align*}
\int\limits_D \EH{5z+3y+2x}\d(x,y,z)&=\int\limits_{x=0}^1\EH{2x}\int\limits_{y=0}^{\frac{2-2x}3}\EH{3y}\int\limits_{z=0}^{\frac{2-2x-3y}5}\EH{5z}\, \mathrm{d}z \, \mathrm{d} y \,\mathrm{d} x\\
&= \int\limits_{x=0}^1\EH{2x}\int\limits_{y=0}^{\frac{2-2x}3}\EH{3y}\left[ \frac{\EH{5z}}5\right]_{z=0}^{\frac{2-2x-3y}5}\, \mathrm{d}y \, \mathrm{d} x\\
&= \frac
15 \int\limits_{x=0}^1\EH{2x}\int\limits_{y=0}^{\frac{2-2x}3}\EH{3y}\left( \EH{2-2x-3y}-1\right) \, \mathrm{d} y \, \mathrm{d} x\\
&= \frac 15 \int\limits_{x=0}^1\EH{2x}\left[\EH{2-2x} y
- \frac{\EH{3y}}3\right]_{y=0}^{\frac{2-2x}3} \, \mathrm{d} x\\
&= \frac 1{15}\int\limits_{x=0}^1\left( \EH 2 (2-2x) - \EH 2 +\EH{2x}\right)\, \mathrm{d} x\\
