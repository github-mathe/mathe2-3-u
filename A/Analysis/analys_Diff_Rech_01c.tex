...
&=\frac 4{\cos^2(2t)} \cdot \left( 3t\cos(t)-2t\cos^3(t) + \sin(t)-3\sin^3(t)\right)\\
f_9   '(t) =& 2t \EH{\sqrt t} + t^2\frac 1{2\sqrt t}\EH{\sqrt t}\\
f_{10}   '(t) =& \frac d{dt}\left( t^{7/8}\right) = \frac 78t^{-1/8}=\frac 7{8\sqrt[8]t}\\
f_{11}   '(t) =& \EH{\frac 1{1+t^2}} \cdot \frac{-2t}{(1+t^2)^2}\\
f_{12}   '(t) =& \frac{d}{dt}\left( \frac{\sin t}{\cos t} \right) = \frac{\cos t \cos t - (-\sin
t) \sin t}{\cos^2 t} = \frac 1{\cos^2 t}\\ 
