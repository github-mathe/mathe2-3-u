...
\begin{abc}
\item
Es bietet sich die Rechnung in Kugelkoordinaten an. Wir verwenden folgende Kugelkoordinaten:
$$
x = r \cos(\varphi) \sin(\theta), \, y= r \sin(\varphi) \sin(\theta), \, z= r \cos(\theta).
$$
Wegen der Bedingung $z\geq 0$ wird $\theta$ auf
...
\end{align*}
\item
Aus der Beziehung $a^2 = r^2 + z^2$ erhalten wir $0 < r < \sqrt{a^2-z^2}$.
