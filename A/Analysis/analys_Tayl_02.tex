...
\begin{tikzpicture}
    ...
    \addplot[domain=0:2,samples=200,red]{2/1^3*(x-1)^3/6}
                                ...
                                node[pos=0.5,font=\footnotesize,label={[label distance=20pt]below:{$R_2(x;1)=\dfrac{2}{\xi^3}\dfrac{(x-1)^3}{3!}\quad \text{ for } \xi=1$}}]{};
    \end{axis}
  \end{tikzpicture}
...
\begin{tikzpicture}
    ...
    \addplot[domain=0:2,samples=200,blue]{2/2^3*(x-1)^3/6}
                                node[pos=0.5,font=\footnotesize,label={[label distance=20pt]below:{$R_2(x;1)=\dfrac{2}{\xi^3}\dfrac{(x-1)^3}{3!}\quad \text{ for } \xi=2$}}]{};
    \end{axis}
  \end{tikzpicture}
%
\end{abc}
