...
\begin{multicols}{2}
\begin{iii}
\item $\int\limits_{t=0}^x (t^2+3t-4)\d t$
\item $\int\limits_{x=-4}^4 (x^3-x)\d x$
\item $\int\limits_{x=-1}^3 \left(5 x^4 + \frac{x^3}3 +2\right) \d x$
\item $\int \frac{1}{(x+1)^3}\d x$.
\end{iii} 
\end{multicols}
...
\begin{iii}
\item $\int \cos(x)\d x$
\item $\int\limits_{x=2}^8 \frac 1x\d x$
\item $\int\limits_{x=0}^{2\pi} \sin(x) \d x$
\item $\int\limits_{x=0}^{\pi/2}\cos(x)\d x$.
\end{iii}
\end{multicols}
\end{abc}
}
...
\item 
\begin{align*}
\int\limits_{t=0}^x\left( t^2+3t-4\right)\d t 
...
\item
\begin{align*}
\int \frac{1}{(x+1)^3}\d x=&-\frac{1}{2(x+1)^2}+C
\end{align*}
\end{iii}
\item 
\begin{iii}
