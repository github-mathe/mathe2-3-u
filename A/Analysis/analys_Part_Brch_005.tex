...
\[x^2 = A(x-3)^2+B(x-3)+C\]
Es folgt
Einsetzen der Nullstelle des Hauptnenners in die Gleichung liefert f\"ur \(x=3\) den Wert \(C=9\) und Koeffizientenvergleich f\"ur \(x^2\) liefert \(A=1\). Nun w\"ahlen wir noch \(x=4\) und erhalten die Gleichung \(16 = A+B+C \Rightarrow B = 16\).
