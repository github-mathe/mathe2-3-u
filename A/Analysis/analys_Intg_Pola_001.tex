...
$$
gegeben.
Bestimmen Sie das Integral $I = \int_R f(x,y) \mathrm{d} (x,y).$
}
...
Es gilt dann:
\begin{align*}
I &= \int_1^2 \int_0^{2\pi} \operatorname{e}^{r^2} r^2 \sin(\varphi) \cdot r \mathrm{d} \varphi \mathrm{d} r \\
&= \int_1^2 \int_0^{2\pi} \operatorname{e}^{r^2} r^3 \sin(\varphi) \mathrm{d} \varphi \mathrm{d} r \\
...
&= \pi \int_1^4 \operatorname{e}^u u  \cdot \frac{1}{2} \mathrm{d} u \\
