...
\item[\textbf{Zu a)}] \begin{align*}
  I  = & \int\limits_1^3\ \int\limits_{-2}^{2} \left( x^2\,y+x\right) \mathrm{d} x\ \mathrm{d} y
   = \int\limits_1^3\ \left[\frac{x^3}{3}\,y+\frac{x^2}{2}\right]_{x=-2}^2 \ \mathrm{d}y \\
   = & \frac{16}{3}\cdot\int\limits_1^3\ y \ \mathrm{d} y
...
\begin{align*}
J& = \ \iint_G x \d  (x,y)  = \int_{x=0}^a x \int_{y=2x}^{\frac{1}{a}x^2 + a} \mathrm{d} \, y\mathrm{d}  x \
 =  \int_{x=0}^a x \left(\dfrac{1}{a}x^2 + a -2 x\right) \mathrm{d} x\\
& = \int_{x=0}^a \left(\dfrac{1}{a}x^3 + ax -2 x^2\right)\mathrm{d} x
