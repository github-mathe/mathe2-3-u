...
Es wird vorausgesetzt, dass $\EH x$ stetig ist und dass gilt $\underset{x\to\infty}\lim \EH{x}=\infty$, somit kann man den
Funktionsgrenzwert durch die Substitution $z=\EH{x}$ bestimmen: 
\begin{align*}
