...
\Loesung{
\textbf{Zu a)} i) \ Man berechnet ohne Schwierigkeit
$$\vec A\vec{z}=(2,0,2)^\top =2 \vec{z},\quad \mbox{also}\quad \fbox{$\lambda=2$.}$$

ii) \ Es gilt \ ${\rm Sp}\,(\vec A)= 10$.

Mit den schon bekannten Eigenwerten \ \fbox{$\lambda_1:=4$}, \fbox{$\lambda_2=2$} \ folgt noch \ $\lambda_3={\rm Sp}\,(\vec A)- \lambda_1-\lambda_2$\,, also\  \fbox{$\lambda_3=4\ .$}


\textbf{Zu b)} Die Gleichung
  \[
...
\textbf{Zu c)} \ Die allgemeine Lösung des DGl--Systems lautet
$$\fbox{$\displaystyle
